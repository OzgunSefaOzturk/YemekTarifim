	...
	<body>
		...
		<div class="container minHeight">			
			...
			<form class="text-center p-5" method="post" action="" enctype="multipart/form-data">
			    ...
			    <!-- Name -->
			    <input type="text" id="defaultContactFormName" class="form-control mb-4" name="tarif" placeholder="Tarif Adı" required>
			    <!-- Subject -->
			    ...
			    <div required class="form-group">
			        <textarea name="malzeme" class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3" placeholder="Malzemeleri giriniz"></textarea>
			    </div>
			    ...
			    <!-- Message -->
			    <div required class="form-group">
			        <textarea name="ekle" class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3" placeholder="Tarif Bilgileri giriniz"></textarea>
			    </div>
